...
namespace WinWebSolution.Win {
    static class Program {
        ...
        static void Main() {
            ...
            winApplication.ObjectSpaceCreated += new EventHandler<ObjectSpaceCreatedEventArgs>(winApplication_ObjectSpaceCreated);
            try {
        ...
        {
            if (e.ObjectSpace is DevExpress.ExpressApp.Xpo.XPObjectSpace)
                ((DevExpress.ExpressApp.Xpo.XPObjectSpace)e.ObjectSpace).NonPersistentChangesEnabled = true;
        }
    }
}
