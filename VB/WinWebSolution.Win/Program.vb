...
#End If
		...
		Private Shared Sub winApplication_ObjectSpaceCreated(ByVal sender As Object, ByVal e As ObjectSpaceCreatedEventArgs)
			If TypeOf e.ObjectSpace Is DevExpress.ExpressApp.Xpo.XPObjectSpace Then
				CType(e.ObjectSpace, DevExpress.ExpressApp.Xpo.XPObjectSpace).NonPersistentChangesEnabled = True
			End If
		End Sub
	End Class
End Namespace
